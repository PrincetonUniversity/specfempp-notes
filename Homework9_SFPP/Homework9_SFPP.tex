...
Since you will be working with Adroit, you do not have to worry about these dependencies because they are already installed. In fact, this utilities are usually installed by default in most LINUX systems. Under WINDOWS, one may use LINUX Subsytem (WSL) or Cygwin (www.cygwin.com), or MinGW (www.mingw.org) to install the software. jkajshf ksjh fkjsdhf kjhsd kfjh ksjdhf kjsdh foiwhe oiejf owdifj osidjf osidj foisjd fosdjf oaspidf 
\ asdoifj lsdjh

alskdjfh kjshdf lkjsd fl


sdkjfh ksjdhf lksjd lfkjs dlfkj lsdkjf ;asljdhrf oweihjcf osdj foiuhsdoij foisjd fof joisdj foijs doifj oisdj foj sdf
