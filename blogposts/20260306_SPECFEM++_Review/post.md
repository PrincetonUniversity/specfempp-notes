...
The <i>conforming</i> simulation is part of Pipatprathanporn et al., 2024 (<a href="https://doi.org/10.1093/gji/ggae238">DOI</a>). Credit: Kentaro G. Hanson (G3, PACM).
<br>
<img width="75%" alt="Seismogram" src="images/seismogram.png">
<br>Seismograms for conforming and nonconforming DG simulation as well as associated error. Credit: Kentaro G. Hanson (G3, PACM).
</p>
...
Wave propagation in a homogeneous Cosserat medium with Stacey boundary conditions on all sides. <i>Left</i>: Magnitude of the displacement component. <i>Right</i>: Rotational (spin) component. Credit: Max Chien (Junior, PACM).
</p>
...
***Acknowledgements***: The initial draft for this post was generated by
Anthropic's Claude Sonnet 4.6 using presentation slides and github release
notes.